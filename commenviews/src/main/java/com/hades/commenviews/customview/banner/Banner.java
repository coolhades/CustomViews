...
import com.hades.commenviews.customview.banner.listener.OnBannerClickListener;
import com.hades.commenviews.customview.banner.loader.ImageLoaderInterface;
import com.hades.commenviews.customview.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    * 描述 扩展配置indicator 形状
    **/
    public Banner setIndicatorResource(int selectedResId, int unselectedResId){
